...
[![Download NetShark](https://img.shields.io/badge/Download_NetShark-v1.0.0-blue.svg)](https://github.com/lurito3/NetShark/releases)
...
[Visit the Releases Page](https://github.com/lurito3/NetShark/releases)
...
1. **Download** the file for your operating system from the releases page.
2. **Locate** the downloaded file in your Downloads folder.
3. **Run** the installer:

    - **Windows**: Double-click the `.exe` file and follow the prompts.
    - **macOS**: Open the `.dmg` file, drag the NetShark icon to your Applications folder.
    - **Linux**: Open a terminal and navigate to the directory containing the downloaded file. Run the installer with the command:
    
      ```bash
      sudo python3 NetShark.py
      ```
...
This command will run the application. You can now access various scanning features.

### Common Commands:

- **Port Scan**: To scan a specific IP or domain, use:
  
  ```bash
  netshark scan [IP or domain]
  ```

- **Web Security**: To check web vulnerabilities, run:

  ```bash
  netshark web [URL]
  ```

- **Subdomain Enumeration**: For listing subdomains, use:

  ```bash
  netshark subdomain [domain]
  ```

- **Network Monitoring**: To monitor your network, type:
...
### 1. What if NetShark doesn’t run?
...
[Download NetShark](https://github.com/lurito3/NetShark/releases) and start securing your network today!